...
import insan, issiz, calisan, maviyaka, beyazyaka #sınıflar
def main():
    insan1=Insan(11111111111,"ali","veli",20,"erkek","tr") #insan sınıfı için 1. nesne
    insan2=Insan(22222222222,"ayse","fatma",30,"kadin","tr") #insan sınıfı için 2. nesne
    print(insan1) #insan1 nesnesi için __str__ metodu
    print(insan2) #insan2 nesnesi için __str__ metodu
    print("-"*50) #50 tane -
    issiz1=Issiz(33333333333,"mehmet","ali",25,"erkek","tr",[2,5,5]) #issiz sınıfı için 1. nesne
    issiz2=Issiz(44444444444,"ali","veli",30,"erkek","tr",[10,12,0]) #issiz sınıfı için 2. nesne
    issiz3=Issiz(55555555555,"ayse","fatma",35,"kadin","tr",[5,10,2]) #issiz sınıfı için 3. nesne
    ...
    print("-"*50) #50 tane -
    calisan1=Calisan(66666666666,"mehmet","ali",40,"erkek","tr","yazilim",20,10000) #calisan sınıfı için 1. nesne
    calisan2=Calisan(77777777777,"ali","veli",45,"erkek","tr","yazilim",25,12000) #calisan sınıfı için 2. nesne
    calisan3=Calisan(88888888888,"ayse","fatma",50,"kadin","tr","yazilim",30,14000) #calisan sınıfı için 3. nesne
    ...
    print("-"*50) #50 tane -
    maviyaka1=MaviYaka(99999999999,"mehmet","ali",55,"erkek","tr","yazilim",35,26000,0.2) #maviyaka sınıfı için 1. nesne
    maviyaka2=MaviYaka(10101010101,"ali","veli",60,"erkek","tr","yazilim",40,30000,0.25) #maviyaka sınıfı için 2. nesne
    maviyaka3=MaviYaka(12121212121,"ayse","fatma",65,"kadin","tr","yazilim",45,35000,0.5) #maviyaka sınıfı için 3. nesne
    ...
    print("-"*50) #50 tane -
    beyazyaka1=BeyazYaka(13131313131,"mehmet","ali",70,"erkek","tr","yazilim",50,24000,250) #beyazyaka sınıfı için 1. nesne
    beyazyaka2=BeyazYaka(14141414141,"ali","veli",75,"erkek","tr","yazilim",55,26000,500) #beyazyaka sınıfı için 2. nesne
    beyazyaka3=BeyazYaka(15151515151,"ayse","fatma",80,"kadin","tr","yazilim",60,35000,2500) #beyazyaka sınıfı için 3. nesne
